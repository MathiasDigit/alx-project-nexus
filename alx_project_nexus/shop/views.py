...
class ProductViewset(MultipleSerializerMixin,ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
    # Nous recuperons tous les produits dans une variable nommee queryset
        queryset = Product.objects.filter(active=True)
        #Verifions la presence du parametre 'category_id' dans l'url et si oui alors appliquons notre filtre
